 ...
 * results of this pipeline, there is a Compute Pipeline (`visualization_pipeline`) which copies the contents of `input_tensor` and `output_tensor` into an
 * Image (`output_image`) which is blitted to the Swapchain.
 *

 ...
 * (`visualization_pipeline`) which copies the contents of the `input_tensor`, `output_tensor` and `postprocessed_tensor` into an Image (`output_image`) which
 * is blitted to the Swapchain.
 *
